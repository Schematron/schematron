...
c:\users\ricko\documents\gestalt-win32-1-0\gestalt.exe  temp\universalTests_eiffel_xslt2.xsl test\include\master.xml > temp\universalTests-eiffel-xslt2.svrl
