<sch:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" queryBinding="xslt2"><sch:title>ISO Schematron schema of W3C XML Schema
		...
		--><sch:ns prefix="foo" uri="bar"/><sch:ns prefix="xs" uri="http://www.w3.org/2001/XMLSchema"/><sch:p class="ul">foo =
						bar</sch:p><!--
	 ================================  
	 ================================  
	 PHASES
	...
	--><sch:rule abstract="true" id="ns1_USState"><sch:assert test="(. = &#34;AK&#34;) or (. = &#34;AL&#34;) or (. = &#34;AR&#34;)"> The value of "<sch:name/>" should be one of
				AK, AL, AR. (It is of type "USState".) </sch:assert></sch:rule><!--Global simpleType, that doesn't have xs:restriction and has list or union, hasn't been processed.--><!--Global simpleType, that doesn't have xs:restriction and has list or union, hasn't been processed.--><!--Global simpleType, that doesn't have xs:restriction and has list or union, hasn't been processed.--></sch:pattern><!--
			============================================================
			============================================================
                                   ELEMENTS 
			============================================================
